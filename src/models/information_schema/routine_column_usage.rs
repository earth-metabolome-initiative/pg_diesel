//! Model struct for the `information_schema.routine_column_usage` view.

use diesel::prelude::*;

/// Model struct for `information_schema.routine_column_usage`.
#[derive(
    Debug, Clone, Hash, PartialEq, Eq, PartialOrd, Ord, Queryable, QueryableByName, Selectable,
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[diesel(table_name = crate::schema::information_schema::routine_column_usage::routine_column_usage)]
pub struct RoutineColumnUsage {
